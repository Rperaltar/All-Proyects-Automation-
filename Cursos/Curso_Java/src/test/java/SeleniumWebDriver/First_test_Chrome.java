...
public class First_test_Chrome {

    public static void main(String[] args) throws InterruptedException {


        //Setting the driver path
        System.setProperty("webdriver.chrome.driver", "/Users/roberto/Documents/Tools_Automation/Java/JAVA_AUTO_SELENIUM/SeleniumWeb/src/main/java/drivers/chromedriver");
